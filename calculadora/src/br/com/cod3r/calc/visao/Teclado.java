...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		/*GridBarLayout, forma mais "facil" de comportar os componentes na tela, pode se usar a
		constraints para passar o eixo x e y e organizar os componentes conforme necessario*/
